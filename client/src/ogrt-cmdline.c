...
const char *gengetopt_args_info_usage = "Usage: ogrt [OPTIONS]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "\n Mode: link-info",
  "      --generate-signature   generate signature object file",
  "      --show-signature=file  show signature of ELF",
    0
};
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->generate_signature_given = 0 ;
  args_info->show_signature_given = 0 ;
  args_info->link_info_mode_counter = 0 ;
}
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->show_signature_arg = NULL;
  args_info->show_signature_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->generate_signature_help = gengetopt_args_info_help[3] ;
  args_info->show_signature_help = gengetopt_args_info_help[4] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->show_signature_arg));
  free_string_field (&(args_info->show_signature_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->generate_signature_given)
    write_into_file(outfile, "generate-signature", 0, 0 );
  if (args_info->show_signature_given)
    write_into_file(outfile, "show-signature", args_info->show_signature_orig, 0);
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        { "help",	0, NULL, 'h' },
        { "version",	0, NULL, 'V' },
        { "generate-signature",	0, NULL, 0 },
        { "show-signature",	1, NULL, 0 },
        { 0,  0, 0, 0 }
      };
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          /* generate signature object file.  */
          if (strcmp (long_options[option_index].name, "generate-signature") == 0)
          {
            args_info->link_info_mode_counter += 1;
          
          
            if (update_arg( 0 , 
                 0 , &(args_info->generate_signature_given),
                &(local_args_info.generate_signature_given), optarg, 0, 0, ARG_NO,
          ...
          /* show signature of ELF.  */
          else if (strcmp (long_options[option_index].name, "show-signature") == 0)
          {
            args_info->link_info_mode_counter += 1;
          
          
            if (update_arg( (void *)&(args_info->show_signature_arg), 
                 &(args_info->show_signature_orig), &(args_info->show_signature_given),
                &(local_args_info.show_signature_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "show-signature", '-',
                additional_error))
              goto failure;
